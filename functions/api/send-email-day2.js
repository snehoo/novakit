...
const SKILL_TIPS = {
  ...
  'brand-ad-copy':                             `Run it once for awareness and once for conversion with the same brief — the output shifts significantly and gives you two angles to A/B test.`,
};
...
const BUNDLE_UPSELL = {
  ...
  'nda-contract-draft':             { name: 'Legal/Biz Bundle',  slug: 'legal-biz',  price: '$45', count: 5  },
  'tos-privacy-policy':             { name: 'Legal/Biz Bundle',  slug: 'legal-biz',  price: '$45', count: 5  },
  ...
  // Fallback for skills not in a bundle
...
function buildDay2Html({ skillName, skillSlug, tip, crossSell, orderId }) {
...
export async function onRequestPost({ request, env }) {
  ...
  const emailHtml = buildDay2Html({ skillName, skillSlug, tip, crossSell, orderId });
